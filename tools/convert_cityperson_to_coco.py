...
DATA_FILE_PATH = 'datasets/data_path/citypersons.mot_train'
...
if __name__ == '__main__':
    ...
    out_path = OUT_PATH + 'mot_train.json'
    ...
    print('loaded mot_train for {} images and {} samples'.format(len(out['images']), len(out['annotations'])))
