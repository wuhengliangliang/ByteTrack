...
cd mix_mot20_ch
ln -s ../MOT20/mot_train mot20_train
ln -s ../crowdhuman/CrowdHuman_train crowdhuman_train
ln -s ../crowdhuman/CrowdHuman_val crowdhuman_val
cd ..
"""

mot_json = json.load(open('datasets/MOT20/annotations/mot_train.json','r'))
...
json.dump(mix_json, open('datasets/mix_mot20_ch/annotations/mot_train.json','w'))