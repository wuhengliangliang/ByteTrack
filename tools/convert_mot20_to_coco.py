...
SPLITS = ['train_half', 'val_half', 'mot_train', 'test']  # --> split training data to train_half and val_half.
HALF_VIDEO = True
...
if __name__ == '__main__':
    ...
    for split in SPLITS:
        if split == "test":
            ...
            data_path = os.path.join(DATA_PATH, 'mot_train')
        ...
        for seq in sorted(seqs):
            ...
            if HALF_VIDEO and ('half' in split):
                image_range = [0, num_images // 2] if 'mot_train' in split else \
