...
mot_json = json.load(open('datasets/mot/annotations/mot_train.json','r'))
...
crowdhuman_json = json.load(open('datasets/crowdhuman/annotations/mot_train.json','r'))
img_id_count = 0
...
ethz_json = json.load(open('datasets/ETHZ/annotations/mot_train.json','r'))
img_id_count = 0
...
cp_json = json.load(open('datasets/Cityscapes/annotations/mot_train.json','r'))
img_id_count = 0
...
json.dump(mix_json, open('datasets/mix_det/annotations/mot_train.json','w'))
