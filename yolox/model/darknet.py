...
from yolox.model.network_blocks import BaseConv, CSPLayer, DWConv, Focus, ResLayer, SPPBottleneck
...
class Darknet(nn.Cell):
    ...
    def construct(self, x):
        ...
        x = self.dark5(x)
        outputs["dark5"] = x
        return outputs["stem"],outputs["dark2"],outputs["dark3"], outputs["dark4"], outputs["dark5"]
